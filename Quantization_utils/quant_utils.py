...
class AsymmetricQuantFunction_Concat(Function):
    """
    Class to quantize the given floating-point values using asymmetric quantization with given range and bitwidth for the concat layer.
    """
    ...
    def forward(ctx, z, bitwidth, quant_mode, z_scaling_factor, case, pre_act_scaling_factor=None,
        ...
        with torch.no_grad():
            ...
            if case == 0:
                ...
                m, e = batch_frexp_refactored(new_scale)
